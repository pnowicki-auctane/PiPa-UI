...
def load_settings() -> dict:
    ...
    # PiPa migration: treat persisted "Hermes" bot_name as the new default "PiPa".
    # Custom user-defined names (anything other than "Hermes" / empty) are preserved.
    if not settings.get("bot_name") or settings.get("bot_name") == "Hermes":
        settings["bot_name"] = "PiPa"
