...
async function newSession(flash, options={}){
  ...
  _newSessionInFlight=(async()=>{
    ...
    // New chat: clear any PiPa skill — a fresh session never inherits skill state.
    if (typeof _pipaRestoreForCurrentSession === 'function') _pipaRestoreForCurrentSession();
...
async function loadSession(sid){
  ...
  // Restore PiPa skill scoped to this session (or clear it for normal chats).
  if (typeof _pipaRestoreForCurrentSession === 'function') _pipaRestoreForCurrentSession();
